...
class MixedDomain(Domain):
    ...
    def generate_derivation(self, seed: int) -> Problem:
        ...
        self.derivation_domains[id(p.universe)] = domain
        return p

    def derivation_done(self, universe: peano.PyDerivation) -> Optional[str]:
        # NOTE: Only works if the universe was generated by this instance of MixedDomain.
        return self.derivation_domains[id(universe)].derivation_done(universe)

    def derivation_state(self, universe: peano.PyDerivation) -> Optional[str]:
        # NOTE: Only works if the universe was generated by this instance of MixedDomain.
        return self.derivation_domains[id(universe)].derivation_state(universe)

    def derivation_actions(self, universe: peano.PyUniverse) -> list[str]:
        return self.derivation_domains[id(universe)].derivation_actions(universe)
